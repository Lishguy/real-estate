...
const Testimonials = () => {
  return (
    ...
    viewport={{once: true}}
    className='container mx-auto py-20 lg:px-32 w-full 
    overflow-hidden' id='Testimonials'>
      <h1 className='text-2xl sm:text-4xl font-bold mb-2
      text-center '>
        Customer <span className='underline underline-offset-4 decoration-1
        font-light under'>Testimonials</span></h1>
      ...
      <div className='flex flex-wrap justify-center gap-8'>
        {testimonialsData.map((testimonial, index)=>(
            ...
            shadow-lg rounded px-8 py-12 text-center '>
